...
class BeatGANsAutoencModel(BeatGANsUNetModel):
    ...
    def forward_with_cond_scale(
        ...
        # random_indx = torch.Tensor([6, 10, 14,  9, 11,  2, 15,  4,  1,  7,  0,  5, 13,  3, 12,  8])
        # cond_perm = [[i[random_indx.long()] for i in cond[0]], cond[1]]

        # logits_perm = self.forward(x,t,cond=cond_perm, prob = 1)

        # c_0 = 1
        # c_T = 5
        # T = 1000
        # cond_scale = ((t + 1)*(c_T - c_0)/T + c_0).mean()
